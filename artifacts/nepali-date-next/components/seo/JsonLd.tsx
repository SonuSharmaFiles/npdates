...
export const organizationLd = {
  ...
  url: `${SITE_URL}/`,
  description:
    "Maintainers of npdates, a free Bikram Sambat ↔ Gregorian date toolkit with age calculator and date difference.",
  logo: {
    "@type": "ImageObject",
...
export const webApplicationLd = {
  ...
  url: `${SITE_URL}/`,
  description:
    "Convert Nepali Bikram Sambat (BS) to AD and back, view today's Nepali date, and calculate age and date differences.",
