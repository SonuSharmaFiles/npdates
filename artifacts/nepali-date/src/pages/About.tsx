  ...
  return (
    <>
      <Seo
        ...
        description="npdates is a fast, accurate Nepali date converter and calendar toolkit. Learn what powers it and our commitment to data quality."
        path="/about"
        breadcrumb={[
          { name: "Home", url: "/" },
      ...
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            Existing Nepali date converters on the web feel dated, slow, or full of
            ads. We thought millions of Nepalis deserve a tool that's as polished
            as the best Western utilities — fast, accurate, and free of clutter.
          </p>
          <h2>How we ensure accuracy</h2>
          <p>
            Our calendar data comes from the published patro (Bikram Sambat
            calendar) for years 1970 BS through 2099 BS. Each conversion is
            performed by counting days from a verified epoch (1 Baisakh 1970 BS =
            13 April 1913 AD), so a Nepali date and its Gregorian equivalent are
            always correct to the day, including weekday.
          </p>
          ...
          <h2>Get in touch</h2>
          <p>
            Spotted an inaccuracy or want to suggest a feature? Open an issue on
            our public tracker or reach out by email.
          </p>
        </div>
      </div>
    </>
