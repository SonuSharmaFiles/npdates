    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        ...
        <article className="prose prose-slate dark:prose-invert prose-headings:font-serif prose-headings:font-bold max-w-none">
          ...
          <p>
            Bikram Sambat (BS) is the official calendar of Nepal. It is a solar calendar based on ancient Hindu traditions.
            Unlike the Gregorian calendar which has fixed days per month, the number of days in a Bikram Sambat month 
            varies from year to year (typically between 29 and 32 days).
          </p>
          <p>
            This variability means that converting between BS and AD is not a simple mathematical formula. 
            Accurate conversion requires historical lookup tables published annually by the government.
            Our converter uses the official Panjika data to ensure 100% accuracy.
          </p>

          <h3>Common conversions</h3>
          <ul>
            <li><Link href="/bs-to-ad/2082/01/01">Nepali New Year 2082</Link></li>
